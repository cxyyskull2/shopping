...
const tbAppSceret = '983d8c18f6f05e63302a46efdc2048bb'; // 应用AppSecret
const tbAppKey = '34982211';    // 应用app_key
const tbPidLast = 111850550173; // 推广位PID最后一位
const jdUrl = 'https://api.jd.com/routerjson';  // 京东官方 url
const jdAppKey = 'bab3f7e15e2718bedf6da8491ade9cad';    // 京东 app key
const jdAppSecret = 'f6b88495bf4c4645aca51aee18a8efd9';    // 京东 app secret
const jdPid = '2022795424_4101122288_3100588957';       // 京东联盟推广位id
const pddUrl = 'https://gw-api.pinduoduo.com/api/router';   // 多多进宝 url
const pddSecret = '1743667ebe5c343c0697ee3fa1628ccf03e04140';   // 拼多多应用client_secret
const pddClientId = '0dfc892ed46a42e896c9271a27387be6'; // 拼多多应用client_id
const pddPid = '30792373_234419786';    // 拼多多推广位PID
const pddCustomParameters = "{\"uid\":\"15084399_190061927\"}";   // 拼多多自定义参数
const vipPid = '3E31D076F16DDCF83D43C23C1269E312';      // 唯品会推广位PID
const thirdUrl = 'https://api-gw.haojingke.com/index.php/v1/api';   // 好京客的URL
const thirdApiKey = '607db745d03f8d04';  // 好京客的API KEY
const thirdJdUnionId = '2022795424';    // 好京客中授权的京东联盟ID
const thirdJdPositionId = '3100588957';    // 京东联盟推广位最后一位
